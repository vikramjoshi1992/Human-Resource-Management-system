...
<form action="emp_updatedprofile.jsp" style="border:1px solid #ccc">
  <div class="container">
	...
	while(rs.next()) {
		...
		String aemail=rs.getString(5);
                ...
                out.println("<div class=clearfix></button><button type=submit class=signupbtn>Update</button></div>");
