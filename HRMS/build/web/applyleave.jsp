...
<div id="tooplate_main">
	<div class="about_box">
		...
		<jsp:include page="emp_transactions.jsp" /><BR>
                ...
                <div>
                    <table width="780" cellspacing=0 border="4" cellpadding=0>
                        <tr><td>
                    <table width="600" height="300"align=center cellspacing=0 border="0" cellpadding=0>
		       <tr><td>
			<fieldset id="fieldhead">
			<legend>Apply for Leave</legend><BR>
			<table cellspacing=1 cellpadding=3>
			<form method=post action="leavestatus.jsp">
				<center>
                                    <tr><td>Date: <input type="text" id="datepicker" name="date"></td>
				<Td align=center><button type=submit accesskey="G"><u>A</u>pply Leave</button></td></tr>
			</form>
			</table>
			</fieldset>
