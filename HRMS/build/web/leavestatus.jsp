...
<div id="tooplate_main">
    ...
    try{
		...
		if(session.getAttribute("login")==null) response.sendRedirect("RMShome3.html?invalid");	
                ...
                String query1="select * from leave where empid='"+empid+"'";
                
                rs=st.executeQuery(query1);
                boolean b=rs.next();
	     
	       if(b) {
		String datelist=rs.getString("datelist");
                String datelist1=datelist+";"+date;
                
                String query="update leave set datelist = '"+datelist1+"' where empid='"+empid+"'";
        ...
        if(eff>0 )
            ...
            out.println("<br/><h2 align=center>'Hurrey!Leave applied'<BR></h2>");
		
	else
					
            out.println("<CENTER><b><u>Failed To apply leave<BR>");
               }
